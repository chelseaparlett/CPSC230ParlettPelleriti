# Class Activities + Review (Class 14)

# Together------------------------------------------------

# 0. Questions?
# 1. Default Arguments
# 2. Giving a function argument values

# Classwork-----------------------------------------------
'''
1. Write a function perfect_number() that takes in an integer, n and returns
true if it's a perfect number, and False otherwise.

Remember a perfect number is a number whose divisors (besides itself) add up
to itself. E.g. 6 (1 + 2 + 3 = 6).
'''
...
add_tags('i', 'Chelsea') -> '<i>Chelsea</i>'
